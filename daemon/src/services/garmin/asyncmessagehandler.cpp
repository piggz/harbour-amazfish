...
*/
    ...
    // ---------------------------------------------------------------------
        ...
        handleProtobufResponse(msg.data);
    }
     else {
...
void AsyncMessageHandler::handleProtobufResponse(const QByteArray &data) {
...
void AsyncMessageHandler::handleAuthenticationRequest(quint16 requestId) {
