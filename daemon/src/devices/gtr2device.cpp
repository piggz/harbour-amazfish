...
void Gtr2Device::initialise()
{
    ...
    if (mi) {
        ...
        connect(mi, &MiBandService::buttonPressed, this, &Gtr2Device::handleButtonPressed, Qt::UniqueConnection);
        connect(mi, &MiBandService::informationChanged, this, &HuamiDevice::informationChanged, Qt::UniqueConnection);
        connect(mi, &MiBandService::serviceEvent, this, &Gtr2Device::serviceEvent, Qt::UniqueConnection);
    }
