...
private:
    // CRC polynomial tables generated by:
      ...
      const int T8_0_start = 0*256;
      const int T8_1_start = 1*256;
      const int T8_2_start = 2*256;
      const int T8_3_start = 3*256;
      const int T8_4_start = 4*256;
      const int T8_5_start = 5*256;
      const int T8_6_start = 6*256;
      const int T8_7_start = 7*256;
