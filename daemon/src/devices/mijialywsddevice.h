...
class MijiaLywsdDevice : public AbstractDevice {
    Q_OBJECT
public:
    explicit MijiaLywsdDevice(const QString& pairedName,
    ...
    void onPropertiesChanged(QString interface, QVariantMap map,
        QStringList list);

    QString deviceType() const override;

    AbstractFirmwareInfo* firmwareInfo(const QByteArray& bytes,
...
protected:
    QBLEService* drv_createService(const QString& uuid,
