...
public:
    ...
    Q_INVOKABLE void sendAlert(const int notificationId, const QString &appId, const QString &appName, const QString &summary, const QString &body, bool allowDuplicate = false);
