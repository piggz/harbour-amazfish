...
function translateSportKey(key) {
    var translations = {
        ...
        "avgCadence": qsTr("Average Cadence"),
        "avgHeartRate": qsTr("Average Heart Rate"),
        "avgSlope": qsTr("Average Slope"),
        "avgTemp": qsTr("Average Temperature"),
        ...
        "minTemp": qsTr("Min Temperature"),
        "movementConsistency": qsTr("Mov Consistency"),
        "movementContinuity": qsTr("Mov Continuity"),
        "movementRhythm": qsTr("Mov Rhythm"),
        "movementSpeedDecay": qsTr("Mov Speed Decay"),
        "movementStability": qsTr("Mov Stability"),
